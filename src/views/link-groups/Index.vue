<template>
    <layout>
        <breadcrumb title="Link groups"
                    :show-hint="true"
                    :hint="{
                        title: 'Group links together to:',
                        description: `<ul>
                                        <li>Simplify multiple link management.</li>
                                        <li>View statistics for a whole group instead of individual links.</li>
                                        <li>Share all links in the group with one link.</li>
                                        <li>And more.</li>
                                      </ul>`
                    }">
            <button type="button"
                ...
                <i class="feather-plus me-2"/> Add New Group
            </button>
        </breadcrumb>
...
<script>
    ...
    import CreateNewGroupModal from "@/components/link-groups/CreateNewGroupModal";
    import Layout from "@/components/layouts/Layout";

    export default {
        name: "LinkGroupsView",
        components: {Layout, CreateNewGroupModal, Preloader, FilterIcon, Breadcrumb},
        setup() {
            // Data
