    ...
    <layout>
        <breadcrumb title="Team"
                    ...
                    :hint="{
                        ...
                        description: `Workspaces are like folders for your links, domains, groups and other resources.
                        They're great for organising your campaigns, collaborating with teammates and managing
                        different projects.`
                    }">
            <button type="button"
                                ...
                                <ul class="dropdown-menu dropdown-menu-end has-arrow right-top animate scaleIn">
                                    ...
                                    <li>
                                        <a href="#" class="dropdown-item"
                                           @click.prevent="copyLink(`this is link ${index}`)">Copy link</a>
                                    </li>
                                </ul>
                            </div>
                        </td>
...
<script>
    ...
    export default {
        name: 'WorkspacesView',
        components: {Layout, Preloader, FilterIcon, Breadcrumb, CreateWorkspaceModal},
        setup() {
            // Data
